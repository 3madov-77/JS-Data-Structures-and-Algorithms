...
- [solution](./for-each/challenges-01.test.js)

## Code Challenge: 02 - Pass by value, pass by reference :sparkles:

- [Pass by value, pass by reference](https://codefellows.github.io/code-301-guide/curriculum/class-02/challenges/)
- [video](https://www.youtube.com/playlist?list=PLVngfM2hsbi-L6G8qlWd8RyRbuTamHt3k)
- [solution](./value-vs-reference/challenges-02.test.js)
...
- [video](https://www.youtube.com/playlist?list=PLVngfM2hsbi-L6G8qlWd8RyRbuTamHt3k)
- [solution](./Sort/challenges-03.test.js)
...
- [video](https://www.youtube.com/playlist?list=PLVngfM2hsbi-L6G8qlWd8RyRbuTamHt3k)
- [solution](./Regular_expressions_part1/challenges-04.test.js)
...
- [solution](./Split,join,slice,splice/challenges-05.test.js)

## Code Challenge: 06 - Object.keys, Object.values, Object.entries :sparkles:
...
- [solution](./Object.keys,Object.values,Object.entries/challenges-06.test.js)

## Code Challenge: 07 - Map :globe_with_meridians:
...
- [solution](./Map/challenges-07.test.js)

## Code Challenge: 08 - Filter :scroll:
...
- [solution](./Filter/challenges-08.test.js)

## Code Challenge: 09 - Reduce :trollface:
...
- [solution](./Reduce/challenges-09.test.js)

## Code Challenge: 10 - Chaining methods :pushpin:

- [video](https://www.youtube.com/playlist?list=PLVngfM2hsbi-L6G8qlWd8RyRbuTamHt3k)
- [solution](./Chaining_methods/challenges-10.test.js)

## Code Challenge: 11 - Regular expressions, part 2 :skull:

- [video](https://www.youtube.com/playlist?list=PLVngfM2hsbi-L6G8qlWd8RyRbuTamHt3k)
- [solution](./Regular_expressions_part1/challenges-04.test.js)

## Code Challenge: 12 - Two-dimensional arrays :heavy_exclamation_mark:

- [Two-dimensional arrays](https://codefellows.github.io/code-301-guide/curriculum/class-12/challenges/).
- [video](https://www.youtube.com/playlist?list=PLVngfM2hsbi-L6G8qlWd8RyRbuTamHt3k)
- [try](https://codefellows.github.io/code-301-guide/curriculum/class-12/challenges/DEMO.html)
- [solution](./Two-dimensional_arrays/challenges-12.test.js)

## Code Challenge: 13 - Includes, every, substring, charAt :red_circle:

- [Includes, every, substring, charAt](https://codefellows.github.io/code-301-guide/curriculum/class-13/challenges/).
- [video](https://www.youtube.com/playlist?list=PLVngfM2hsbi-L6G8qlWd8RyRbuTamHt3k)
- [try](https://codefellows.github.io/code-301-guide/curriculum/class-13/challenges/DEMO.html)
- [solution](./Includes,every,substring,charAt/challenges-13.test.js)

## Code Challenge: 14 - Combination of all methods :octocat:

- [solution](./Combination_of_all_methods/challenges-14.test.js)

...
const sortBackwards = (arr) => {
  // Solution code here...
  arr.sort((a,b) => {if(a < b){return 1}if(a == b){return 0}else {return -1}});
  return arr;
};
...
const sortByPrice = (arr) => {
  // Solution code here...
  arr.sort((a,b) => {if(a.price > b.price){return 1}if(a.price == b.price){return 0}else{return -1}});
  return arr;
};
...
const sortNumbersByLength = (arr) => {
  // Solution code here...
  arr.sort((a,b)=> {if(a.toString().length > b.toString().length){return 1}if(a.toString().length == b.toString().length){return 0}else {return -1}});
  return arr;
};
...
const sortPeople = (arr) => {
  // Solution code here...
  arr.sort((a,b)=> {if(a.lastName > b.lastName){return 1}if(a.lastName == b.lastName){return 0}else{return -1}})
  return arr;
};
...
const sortPeopleBetter = (arr) => {
  // Solution code here...
  arr.sort((a,b) =>{if(a.lastName > b.lastName){return 1}if(a.lastName == b.lastName){if(a.firstName > b.firstName){return 1}if(a.firstName == b.firstName){if(a.age > b.age){return 1}else{return -1}}else{return -1}}else{return -1}});
  return arr;
};
...
const sortMeetingsByDay = (arr) => {
  ...
  arr.sort((a,b) =>{if(daysOfWeek.indexOf(a.dayOfWeek) > daysOfWeek.indexOf(b.dayOfWeek)){return 1}if(daysOfWeek.indexOf(a.dayOfWeek) == daysOfWeek.indexOf(b.dayOfWeek)){return 0}else {return -1}});
  return arr;
